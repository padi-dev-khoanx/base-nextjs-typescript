  ...
  return (
    <div
      className={`flex justify-between ${
        !disableBorder && "border-b border-b-[#D9D9D9]"
    ...
    >
      <div>
        <div className="flex items-center cursor-pointer" onClick={customBack}>
          ...
          <div
            className={`${
              !subTitle && "truncate w-96"
            } 'text-xl leading-[28px] font-medium'`}
          >
            {title}
          </div>
          {subTitle && (
            <span className="text-black/[0.45] text-sm leading-[22px] pl-[12px]">
              {subTitle}
            </span>
          )}
        </div>
